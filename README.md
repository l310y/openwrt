...
3. `git clone -b 19.07 --single-branch https://github.com/wk8838299/openwrt openwrt19` 命令下载好源代码，然后 `cd openwrt19` 进入目录
...
------------------------------------------------------
该源码包含MTK AP驱动,编译出来的固件默认ip:10.10.40.1 默认密码：admin
 需要的自行到release下载固件，包含常见的所有插件。
 -----------------------------------------------------
